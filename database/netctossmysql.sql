...
(
 	...
 	service_id 	int(10) not null,
 	cost 		double(13,2),
	constraint bill_item_id_pk  primary key(item_id),
	constraint bill_itme_bill_id FOREIGN KEY(bill_id) references bill(bill_id),
	constraint bill_itme_bill_id FOREIGN KEY(bill_id) references service(service_id) 
);
--模块表
mysql
